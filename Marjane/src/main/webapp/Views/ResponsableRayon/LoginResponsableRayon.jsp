...
<section style="background-image: url(${pageContext.request.contextPath}/Assets/Marjane-Holding.webp);
  ...
  <form action="auth-responsable-rayon" method="POST" class="relative py-3 sm:max-w-xl sm:mx-auto">
    <div
