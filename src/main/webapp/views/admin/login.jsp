<!-- login page tailwind css template free download -->
...
<head>
    ...
    <style>
        body {
            background-image: url("${pageContext.request.contextPath}/assets/images/Marjane.jpg");
...
<!-- messages form request -->



<!-- login page with tailwind css  and background image -->
<div class="flex justify-center items-center h-screen section" >
    <div class="bg-white w-96 rounded-lg shadow-xl p-6 flex justify-center items-center ">
        <div class="">
            ...
            <div class="flex justify-center items-center">
                <img src="${pageContext.request.contextPath}/assets/images/logo.png" alt="logo" class="w-20 h-20">
            </div>
        <form action="login" method="post">
            <div class="mt-4">
                <input type="text" name="email" placeholder="email" class="w-full px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:border-green-500" required>

            </div>
            <div class="mt-4">
                <input type="password" name="password" placeholder="Password" class="w-full px-4 py-2 border rounded-lg text-gray-700 focus:outline-none focus:border-green-500" required>
            </div>
            <div class="flex justify-between items-center mt-4">
                <button type="submit" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-green-600 focus:outline-none">Login</button>
                <a href="#" class="text-sm text-blue-500 hover:text-blue-700 focus:text-green-700 focus:outline-none">Forgot Password?</a>
            </div>
        </form>
        </div>

    <!-- image login from undraw -->
    <div class="hidden lg:block lg:w-1/2 lg:relative w-full">
        <svg
